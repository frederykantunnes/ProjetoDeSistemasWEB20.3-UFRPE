        ...
        <!-- Profile Photo -->
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="/storage/{{ $this->user->getProfilePhoto() }}" alt="{{ $this->user->name }}" class="rounded-full h-20 w-20 object-cover" style="width: 8rem; height: 8rem;">
                </div>

                <!-- New Profile Photo Preview -->
                <div class="mt-2" x-show="photoPreview">
                    <span class="block rounded-full w-20 h-20"
                          x-bind:style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + photoPreview + '\'); width: 8rem; height: 8rem;'">
                    </span>
                </div>
